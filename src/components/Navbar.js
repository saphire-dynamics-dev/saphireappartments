        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button 
              ...
              className="bg-purple-gradient text-white px-4 py-2 rounded-lg text-sm hover:bg-purple-secondary transition-colors"
            >
              Contact Us
            </button>
          </div>
          ...
          <div className="md:hidden bg-white border-t border-purple-lighter">
            <div className="px-4 py-2 space-y-1">
              ...
              <button 
                ...
                className="block w-full text-left py-2 text-gray-600 hover:text-purple-primary"
              >
                Contact Us
              </button>
              <button 
                onClick={() => setIsContactModalOpen(true)}
                className="block w-full bg-purple-gradient text-white py-2 px-4 rounded-lg text-sm mt-2 hover:bg-purple-secondary transition-colors"
              >
                Get In Touch
              </button>
            </div>
