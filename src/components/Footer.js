        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-purple-lighter rounded-full flex items-center justify-center hover:bg-purple-light hover:text-white cursor-pointer transition-colors group"
              >
